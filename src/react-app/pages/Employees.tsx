...
export default function Employees() {
  ...
  const getStatusBadge = (isActive: boolean) => {
    return isActive
      ? { text: 'نشط', class: 'bg-accent-50 text-accent-700' }
        ...
        <div className="glass-card p-6 mb-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-500">إدارة وتتبع فريق العمل</p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="bg-gradient-to-br from-success/5 to-success/10 rounded-xl p-4 border border-success/20">
              ...
              <p className="text-3xl font-bold text-accent-700 font-numbers">{activeEmployees}</p>
            </div>
              ...
              <table className="w-full">
                <thead className="border-b border-gray-100">
                  <tr>
                    ...
                    <th className="px-6 py-4 text-right text-xs font-medium text-gray-400 uppercase tracking-wider">الصلاحية</th>
                    <th className="px-6 py-4 text-right text-xs font-medium text-gray-400 uppercase tracking-wider">الفرع</th>
                    <th className="px-6 py-4 text-right text-xs font-medium text-gray-400 uppercase tracking-wider">الإحصائيات</th>
                    <th className="px-6 py-4 text-right text-xs font-medium text-gray-400 uppercase tracking-wider">آخر دخول</th>
                ...
                <tbody className="divide-y divide-gray-100">
                  {filteredEmployees.map((employee) => {
                    ...
                    return (
                      <tr key={employee.id} className="hover:bg-primary-50/20 transition-colors">
                        ...
                        <td className="px-6 py-4">
                          <div className="text-sm">
                            ...
                            <p className="text-gray-500 font-numbers">-</p>
                          </div>
                        </td>
                        <td className="px-6 py-4">
