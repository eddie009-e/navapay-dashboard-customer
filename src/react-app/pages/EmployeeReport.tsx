...
import { Users, TrendingUp, DollarSign, Award, Lock, Crown, Loader2 } from 'lucide-react';
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-right">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">تتبع مبيعات وإنتاجية كل موظف</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-success/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">مقارنة أداء فروعك المختلفة</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-success/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">صلاحيات وأدوار مخصصة</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-success/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">إدارة ودفع رواتب الفريق</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-success/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">رسوم بيانية وتحليلات متقدمة</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-success/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">تحكم كامل في فروعك من مكان واحد</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="animate-fadeIn">
        ...
        <div className="bg-white rounded-xl p-6 mb-6 border border-gray-200 shadow-sm">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-gray-600">تحليل أداء ومبيعات فريق العمل</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="bg-gradient-to-br from-accent/5 to-accent/10 rounded-lg p-4 border border-accent/20">
              ...
              <p className="text-xs text-gray-600 mt-1">عملية</p>
            </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
          <div className="p-6 border-b border-gray-200">
            ...
            <p className="text-sm text-gray-600">مقاييس تفصيلية لكل موظف</p>
          </div>
            ...
            <table className="w-full">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  ...
                  <th className="px-6 py-4 text-right text-sm font-medium text-gray-700">إجمالي المبيعات</th>
                  <th className="px-6 py-4 text-right text-sm font-medium text-gray-700">عدد المعاملات</th>
                  <th className="px-6 py-4 text-right text-sm font-medium text-gray-700">متوسط المعاملة</th>
