          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-500">عام {selectedYear}</p>
              </div>
            </div>
          ...
          <div className="glass-card p-6">
            ...
            <div className="space-y-4">
              {quarterlyData.map((quarter) => (
                <div key={quarter.quarter} className="p-4 bg-surface rounded-xl">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className={`flex items-center gap-1 px-2 py-1 rounded-xl ${
                      quarter.growth > 25 ? 'bg-accent-50 text-accent-700' : 'bg-gray-200 text-gray-700'
                    }`}>
                      <TrendingUp size={14} />
                  ...
                  <p className="text-sm text-gray-500">{quarter.transactions} عملية</p>
                </div>
              ))}
            </div>
          </div>
              ...
              {topMonths.map((month, index) => (
                <div key={month.month} className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-500">{month.transactions} عمليات</p>
                  </div>
        ...
        <div className="glass-card p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="p-4 bg-surface rounded-xl">
              <p className="text-sm text-gray-500 mb-2">معدل النمو السنوي</p>
              ...
              <div className="flex items-center gap-1">
                ...
                <p className="text-sm text-gray-500">مقارنة بالسنة الماضية</p>
              </div>
            </div>
            <div className="p-4 bg-surface rounded-xl">
              <p className="text-sm text-gray-500 mb-2">متوسط العملية</p>
              <p className="text-3xl font-bold text-gray-900 font-numbers mb-2">
                {formatCurrency(yearlyStats.averageTransaction)}
              </p>
            </div>
            <div className="p-4 bg-surface rounded-xl">
              <p className="text-sm text-gray-500 mb-2">إجمالي العمليات</p>
              <p className="text-3xl font-bold text-gray-900 font-numbers mb-2">
                {yearlyStats.totalTransactions}
              </p>
            </div>
            <div className="p-4 bg-surface rounded-xl">
              <p className="text-sm text-gray-500 mb-2">أفضل شهر</p>
              <p className="text-xl font-bold text-gray-900 mb-1">
                {yearlyStats.bestMonth}
              </p>
              <p className="text-sm text-accent-700 font-numbers">
